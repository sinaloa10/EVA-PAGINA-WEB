      ...
      <div className="container mx-auto p-4 flex-wrap">
            ...
            <div className="flex items-center">
              ...
              <div className="w-full">
                <div className="text-center text-4xl">
                  <h2 className="text-gray-700">Reporte General</h2>
                  <h3 className="text-pink-500">Semana 1</h3>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold mb-2 text-blue-500">Pacientes</h2>
          ...
          {/* Alertas Urgentes */}
          <div className="bg-white p-4 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold mb-2 text-red-500">Alertas Urgentes</h2>
            <div className="max-h-80 overflow-y-auto scroll-container">
              <ul>
                {alertas.map((alert, index) => (
                  <li key={index} className="p-2 text-black flex items-center hover:rounded-2xl hover:bg-red-500 hover:text-white">
                    <div style={{ width: '30px', height: '30px', marginRight: '8px', flexShrink: 0 }}>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ width: '100%', height: '100%' }}>
                        <path fill="#981616" d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-384c13.3 0 24 10.7 24 24l0 112c0 13.3-10.7 24-24 24s-24-10.7-24-24l0-112c0-13.3 10.7-24 24-24zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"/>
                      </svg>
                    </div>
          ...
          {/* Próximas citas */}
          <div className="bg-white p-4 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold mb-2 text-green-500">Próximas Citas</h2>
          ...
          {/* Tareas Pendientes */}
          <div className="bg-white p-4 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold mb-2 text-purple-500">Tareas Pendientes</h2>
            <div className="max-h-96 overflow-y-auto scroll-container">
              <ul>
                {tasks.map((task, index) => (
                  <li key={index} className="p-2 text-black flex items-center hover:rounded-2xl hover:bg-purple-500 hover:text-white">
                    <div style={{ width: '30px', height: '30px', marginRight: '8px', flexShrink: 0 }}>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" style={{ width: '100%', height: '100%' }}>
                        <path fill="#c4b6ec" d="M192 0c-41.8 0-77.4 26.7-90.5 64L64 64C28.7 64 0 92.7 0 128L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64l-37.5 0C269.4 26.7 233.8 0 192 0zm0 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM128 256a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM80 432c0-44.2 35.8-80 80-80l64 0c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16L96 448c-8.8 0-16-7.2-16-16z"/>
                      </svg>
                    </div>
                    <span>{task.task}</span>
                  </li>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg md:col-span-2">
            <h2 className="text-xl font-semibold mb-2 text-pink-500">Establece una actividad para el paciente</h2>
                    ...
                    <li key={index} className="p-2 text-black flex items-center hover:rounded-2xl hover:bg-pink-500 hover:text-white">
                      <div style={{ width: "30px", height: "30px", marginRight: "8px", flexShrink: 0 }}>
                        <svg xmlns="http://www.w3.org/2000/svg" height="32" width="36" viewBox="0 0 576 512">
                          <path fill="#f6938c" d="M96 80c0-26.5 21.5-48 48-48l288 0c26.5 0 48 21.5 48 48l0 304L96 384 96 80zm313 47c-9.4-9.4-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L409 161c9.4-9.4 9.4-24.6 0-33.9zM0 336c0-26.5 21.5-48 48-48l16 0 0 128 448 0 0-128 16 0c26.5 0 48 21.5 48 48l0 96c0 26.5-21.5 48-48 48L48 480c-26.5 0-48-21.5-48-48l0-96z"/>
                        </svg>
                      </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg col-span-1 md:col-span-full">
            <h2 className="text-xl font-semibold mb-2 text-blue-500">Gráficos de evolución del paciente</h2>
