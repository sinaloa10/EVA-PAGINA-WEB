...
function Survey() {
  ...
  // --- Pantalla de acceso SOLO para la encuesta y footer ---
  if (!isAuthenticated) {
    return (
      <div className="text-gray-700 font-sans">
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="flex items-center justify-center">
              <form
                ...
                className="bg-white p-8 rounded-xl max-w-sm w-full"
              >
        ...
        {/* --- Pantalla de acceso a la encuesta --- */}
