...
// --- Definición de colores estáticos y fuentes ---
const evaColors = {
  light: '#EAF7FF',
  accent: '#8DC8FA',
};

// --- Componentes de Iconos (para mejor legibilidad) ---
const HeartIcon = ({ style, className }) => (
  <svg style={style} className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
...
function Survey() {
  ...
  const handleSubmit = (e) => {
    ...
    setIsSubmitted(true);
    // Aquí iría la lógica para enviar `formData` a un servidor.
  };

  const handleFooterSubmit = (e) => {
    e.preventDefault();
    if(formData.footer_email) {
        console.log(`Email de contacto registrado: ${formData.footer_email}`);
      ...
      <main>
        ...
        <section id="inicio" className="py-20 md:py-32" >
            <div className="container mx-auto px-6 text-center">
                <h1 className="text-4xl md:text-6xl font-bold  leading-tight">Tu experiencia puede transformar la salud mental digital.</h1>
                <p className="mt-6 text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">Ayúdanos a construir herramientas más efectivas y humanas para el ejercicio terapéutico en la era digital.</p>
                <div className="mt-12">
                    <a href="#encuesta" className="text-white font-bold py-4 px-10 rounded-full text-lg hover:bg-opacity-90 transition-all shadow-lg hover:shadow-xl" style={{ backgroundColor: evaColors.accent }}>
                        Responder Encuesta
                    </a>
                </div>
            </div>
        ...
        {/* --- Survey Section --- */}
        <section id="encuesta" className="py-20 md:py-24 bg-white">
        ...
        <section id="eva" className="py-20" style={{ backgroundColor: evaColors.light }}>
            <div className="container mx-auto px-6 text-center max-w-3xl">
                <h2 className="text-3xl font-bold text-gray-800">¿Qué es EVA Salud Mental?</h2>
            ...
            <div className="container mx-auto px-6 max-w-xl text-center">
                ...
                <form onSubmit={handleFooterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                    <input 
                        ...
                        className="flex-grow p-3 border border-gray-300 rounded-md focus:ring-2 focus:outline-none" 
